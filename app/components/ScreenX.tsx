...
import {
  ...
  Platform,
  ScrollView,
  ScrollViewProps, StatusBar, StatusBarProps, StatusBarStyle,
  StyleProp,
  View,
  ViewStyle
} from "react-native";
...
/*
* Example of use
* <ScreenX preset="auto" contentContainerStyle={$screenContentContainer} safeAreaEdges={["top", "bottom"]}>
*
*/
...
export function ScreenX(props: ScreenProps) {
  const {
